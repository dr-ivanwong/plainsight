...
3. **Apple stopped disclosing interest expense from FY2023.** The fixture asserts the not-reported-zero state, as the entry flow invites; M8 renders "n/m: no interest burden" and R4 abstains from FY2023 on. Apple does carry term debt; the detail-sheet framing ("the filing does not break out an interest burden") is Phase 1 copy to keep honest.
