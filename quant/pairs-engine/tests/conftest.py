...
Every builder takes an explicit generator so each test owns its seed and
the suite is deterministic end to end: a cointegrated pair is built from
a known hedge ratio and a known mean-reversion speed, and the tests
assert the scan recovers what was planted.
"""
