...
| [docs/plan/2026-07-22-pairs-research-integration.md](docs/plan/2026-07-22-pairs-research-integration.md) | The pairs sleeve (chartered 2026-07-22, main plan §12 entry 17): quant engine, artefact contract, transport, Pairs surfaces, six-slice staging |
...
- **Never buy/sell language** on research and education surfaces; scoped 2026-07-22 (main plan §12 entry 17) so the pairs sleeve's live surfaces may describe the engine's own targets, positions and limits, advising no one. Red flags are "items to investigate," education framing throughout (main plan §2 non-goals as amended; tripwires in §15).
