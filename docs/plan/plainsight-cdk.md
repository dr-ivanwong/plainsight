...
| `Api` | syd | 2 | HTTP API Gateway (access logs on, retention set), read Lambdas; Phase 3 adds sync routes + BYOK proxy pass-through; Cognito authorizer attached where flagged | no | n/a |
