...
41 findings. After the 2026-07-19 pass (update note at the top): UI-1, INFRA-1, FE-2, BE-2, FE-1, FE-3, INFRA-2, INFRA-3 and INFRA-4 fixed, and four sync-convergence findings deferred under single-device operation. Open: 0 P0, 3 P1, 14 P2, 15 P3.
